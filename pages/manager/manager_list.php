...
<table class="table table-bordered table-hover manager-table">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a href="manager_edit.php?id=<?= htmlspecialchars((string) $m['id']) ?>">編集</a> |
                <a href="manager_delete.php?id=<?= htmlspecialchars((string) $m['id']) ?>" onclick="return confirm('削除しますか？');">削除</a>
            </td>
        </tr>
        <?php endforeach; ?>
    </tbody>
