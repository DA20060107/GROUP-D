...
INSERT INTO employees (id, name, email, phone, hire_date, position, note, is_active, skill_level) VALUES
    ...
    (5,  '星野蒼',   'hoshino-ao@example.com',     '090-1000-0005', '2024-01-01', 'ホール・キッチン', NULL, 1, 4),
    ...
    (8,  '星野理一', 'hoshino-riichi@example.com', '090-1000-0008', '2025-04-01', 'キッチン',        NULL, 1, 3),
    (9,  '石井颯斗', 'ishii@example.com',          '090-1000-0009', '2025-05-01', 'ホール',          NULL, 1, 3),
    (10, '陶修斗',   'sue@example.com',            '090-1000-0010', '2025-06-01', 'キッチン',        NULL, 1, 2),
    (11, '吉田隆人', 'yoshida@example.com',        '090-1000-0011', '2025-07-01', 'ホール',          NULL, 1, 3),
    (12, '川口将英', 'kawaguchi@example.com',      '090-1000-0012', '2025-08-01', 'ホール・レジ',    NULL, 1, 4),
    (13, '高木悠希', 'takagi@example.com',         '090-1000-0013', '2025-09-01', 'キッチン',        NULL, 1, 3);
