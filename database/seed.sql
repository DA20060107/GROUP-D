...
-- employees: 従業員情報（5名）
-- ------------------------------------------------------------
INSERT INTO employees (id, name, email, phone, hire_date) VALUES
    (1, '山田 太郎', 'yamada@example.com', '090-1111-1111', '2023-04-01'),
    (2, '佐藤 花子', 'sato@example.com',   '090-2222-2222', '2023-06-01'),
    (3, '鈴木 次郎', 'suzuki@example.com', '090-3333-3333', '2024-01-10'),
    (4, '高橋 美咲', 'takahashi@example.com', '090-4444-4444', '2024-04-01'),
    (5, '田中 健太', 'tanaka@example.com', '090-5555-5555', '2025-02-15');
...
-- shifts: サンプルシフト
-- ------------------------------------------------------------
INSERT INTO shifts (employee_id, shift_date, start_time, end_time, status) VALUES
    (1, '2026-06-14', '17:00:00', '22:00:00', 'scheduled'),
    (2, '2026-06-15', '17:00:00', '22:00:00', 'leave_requested'),
    (3, '2026-06-15', '18:00:00', '23:00:00', 'scheduled'),
    (4, '2026-06-16', '17:00:00', '22:00:00', 'scheduled'),
    (5, '2026-06-18', '18:00:00', '23:00:00', 'scheduled');

-- ------------------------------------------------------------
-- availability: サンプル勤務可能日（店長が登録）
-- ------------------------------------------------------------
INSERT INTO availability (employee_id, available_date, start_time, end_time, created_by) VALUES
    (1, '2026-06-14', '17:00:00', '22:00:00', 1),
    (2, '2026-06-15', '17:00:00', '22:00:00', 1),
    (3, '2026-06-15', '17:00:00', '23:00:00', 1),
    (4, '2026-06-16', '17:00:00', '22:00:00', 1),
    (5, '2026-06-18', '18:00:00', '23:00:00', 1);
